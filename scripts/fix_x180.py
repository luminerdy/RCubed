...
"""
Fix: X forward 180° 
Current: Green front, Yellow top
After X 180°: Blue front, White top
Then X forward 90° more: White front, Blue top
"""
import sys
import os
import time
...
def main():
    ...
    print("Current: Green front, Yellow top")
    ...
    # X forward 90°: 0:B→C, 6:B→A
    print("X forward 90° (1 of 3)...")
    ctrl.setSpeed(0, 60)
    ctrl.setSpeed(6, 45)
    ...
    # X forward another 90°: 0:C→A, 6:A→C (now 180° total)
    print("X forward 90° (2 of 3)...")
    ctrl.setTarget(0, GRIPPER[0]['A'] * 4)
    ctrl.setTarget(6, GRIPPER[6]['C'] * 4)
    time.sleep(2.5)
    
    # Reset to B for third rotation
    print("Resetting 0&6 to B...")
    # Need to transfer hold first
    ctrl.setSpeed(3, 50)
    ctrl.setSpeed(9, 50)
    ...
    # X forward final 90°: 0:B→C, 6:B→A (now 270° total)
    print("X forward 90° (3 of 3)...")
    ctrl.setTarget(0, GRIPPER[0]['C'] * 4)
    ctrl.setTarget(6, GRIPPER[6]['A'] * 4)
    time.sleep(2.5)
    ctrl.setSpeed(0, 0)
